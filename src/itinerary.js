const itinerary = {
  ...
  schedule: [
    ...
    },
    {
      ...
      date: "March 28, 2025",
      events: [
        { time: "9:30 AM", description: "Meditate" },
        { time: "10:00 AM", description: "Explore hotels: Bellagio, Wynn, Cosmopolitan, Mandalay Bay, Waldorf Astoria, Park MGM, Venetian" },
        { time: "10:30 AM", description: "Kyon and Peter check out and leave bags in someone's room" },
        { time: "11:15 AM", description: "Brunch at Sugarcane" },
        { time: "12:00 PM", description: "Casino" },
        { time: "1:00 PM", description: "Sphere Show (KA and Alex will go to Area 15 during this time)", endTime: "3:00 PM" },
    ...
    },
    {
      ...
      events: [
        ...
        { time: "10:00 AM", description: "Brunch at Kassi Beach House" },
